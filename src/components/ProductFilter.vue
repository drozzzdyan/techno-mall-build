<template>
  <aside class="filter">
    ...
    <form class="filter__form form" action="#" method="get" @submit.prevent="submitFilter()">
        ...
        <ul class="colors">
          <li class="colors__item" v-for="color in colors" :key="color.colorHex">
            <label class="colors__label">
              <input class="colors__radio sr-only" type="radio" name="color" :value="color.colorId" v-model="currentColorId">
      ...
      <button class="filter__reset button button--second" type="button" @click.prevent="resetFilter()">
        Сбросить
      </button>
    </form>
  </aside>
